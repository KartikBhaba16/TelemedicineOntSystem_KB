...

{
...

	{
		...
		if($this->session->get_userdata('login_type')){
			$type_login = $this->session->get_userdata('login_type')['login_type'];
			$this->session->unset_userdata($type_login .'_id');
			$this->session->unset_userdata($type_login .'_login');
			$this->session->unset_userdata($type_login);
		}
