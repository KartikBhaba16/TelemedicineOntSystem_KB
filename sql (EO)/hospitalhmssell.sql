...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 30 nov. 2022 à 21:25
...
(1, 'Madhuri Pilat', 'accountant@accountant.com', 'accountant', 'Mumbai, India', '9800008888'),
(2, 'cherif amine sriret', 'cherifsriret@gmail.com', 'admin', '161 cité 400 logts Tixraine Birkhadem', '+213699042510');
...
(1, 'Administrator', 'Kartik@gmail.com', 'admin', 'Admin Address', '9800000000');
...
CREATE TABLE `bed` (
  `bed_id` int NOT NULL,
  `bed_number` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `bed_allotment` (
  ...
  `bed_id` int NOT NULL,
  `patient_id` int NOT NULL,
  `allotment_timestamp` int NOT NULL,
  `discharge_timestamp` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(1, 'Anesthesiology1', 'Anesthesiology'),
...
CREATE TABLE `diagnosis_report` (
  ...
  `report_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'xray,blood test',
  `document_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'text,photo',
...
CREATE TABLE `doctor` (
  ...
  `phone` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `department_id` int NOT NULL,
  `profile` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;



INSERT INTO `doctor` (`doctor_id`, `name`, `email`, `password`, `address`, `phone`, `department_id`, `profile`) VALUES
(1, 'Kartik', 'Kartik@doctor.com', 'doctor', 'Thunder Bay, ON', '9800000000', 4, 'profile details here'),
(2, 'Chris', 'Chris@doctor.com', 'admin', 'Thunder Bay, ON', '699000445454', 1, '1212'),
(3, 'Peter', 'Peter@doctor.com', 'admin', 'Thunder Bay, ON', '054545454', 2, '1002'),
(4, 'Fits', 'Fits@doctor.com', '12121', 'Thunder Bay, ON', '12121', 3, '121237');



CREATE TABLE `email_template` (
  `email_template_id` int NOT NULL,
  `task` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `subject` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
(1, 1, 'Blood Test', 'Blood test for maleria, Nov 2015', 500, 1448985663, 'paid'),
(2, 2, 'Fracture', 'Fracture bandage.', 1200, 1448985702, 'paid'),
(3, 2, 'dazdaz', 'azdazdazd', 0, 1669710006, 'paid'),
(4, 2, 'dazd', 'azda adzazd', 7800, 1669710020, 'paid');
...
CREATE TABLE `language` (
  ...
  `bengali` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `spanish` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `arabic` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `dutch` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `russian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `chinese` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `turkish` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `portuguese` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `hungarian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `french` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `greek` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `german` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `italian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `thai` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `urdu` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `hindi` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `latin` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `indonesian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `japanese` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `korean` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
(8, 'doctor', 'doctor', 'ডাক্তার', 'doctor', 'طبيب', 'dokter', 'врач,en', '医生,en', 'doktor', 'médico', 'orvos', 'médecin', 'γιατρός', 'Arzt', 'medico', 'คุณหมอ', 'ڈاکٹر', 'चिकित्सक', 'Medicus', 'dokter', '医者', '의사'),
(9, 'patient', 'patient', 'রোগীর', 'paciente', 'المريض', 'patiënt', 'пациент,en', '病人,en', 'hasta', 'paciente', 'beteg', 'patients', 'ασθενής', 'Patienten', 'paziente', 'ผู้ป่วย', 'مریض', 'रोगी', 'Patientes', 'pasien', '患者', '환자'),
(10, 'pharmacist', 'pharmacist', 'ফার্মাসিস্ট', 'farmacéutico', 'صيدلي', 'apotheker', 'фармацевт', '药剂师,en', 'eczacı', 'farmacêutico', 'gyógyszerész', 'pharmacien', 'φαρμακοποιός', 'Apotheker', 'farmacista', 'เภสัชกร', 'فارماسسٹ', 'औषध बनानेवाला', 'pharmacist', 'apoteker,en', '薬剤師', '약사,en'),
(11, 'laboratorist', 'laboratorist', 'ল্যাবরেটরিস্ট', 'laboratorista', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorista', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist,eo', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist', 'laboratorist,eo', 'laboratorist', 'laboratorist'),
(12, 'accountant', 'accountant', 'হিসাবরক্ষক', 'contador', 'محاسب', 'boekhouder', 'бухгалтер', '会计,en', 'muhasebeci', 'contador', 'könyvelő', 'comptable', 'λογιστής', 'Buchhalter', 'ragioniere', 'สมุห์บัญชี', 'اکاؤنٹنٹ', 'मुनीम', 'Ratiocinatore', 'akuntan', '会計士', '회계 원'),
(13, 'monitor_hospital', 'monitor hospital', 'মনিটর হাসপাতালে', 'hospital monitor', 'مستشفى رصد', 'beeldscherm ziekenhuis', 'монитор больницу', '监测医院,en', 'monitör hastane', 'Monitor hospitalar', 'monitor kórházban', 'hôpital moniteur', 'οθόνη από νοσοκομείο', 'Monitor Krankenhaus', 'ospedale monitor', 'โรงพยาบาลจอ', 'مانیٹر ہسپتال', 'मॉनिटर अस्पताल', 'notes hospitalis', 'memantau rumah sakit', 'モニター病院', '모니터 병원,en'),
(14, 'nurse', 'nurse', 'নার্স', 'enfermera', 'ممرضة', 'verpleegster', 'медсестра', '护士,en', 'hemşire', 'enfermeira', 'nővér', 'infirmière', 'νοσοκόμα', 'Krankenschwester', 'infermiere', 'พยาบาล', 'نرس', 'नर्स', 'nutricem', 'perawat', '看護師', '간호사'),
(15, 'department', 'department', 'বিভাগ', 'departamento', 'قسم', 'afdeling', 'отдел', '部门,en', 'bölüm', 'departamento', 'osztály', 'département', 'τμήμα', 'Abteilung', 'Dipartimento', 'แผนก', 'محکمہ', 'विभाग', 'Department', 'departemen', '部門', '부'),
(16, 'dashboard', 'dashboard', 'ড্যাশবোর্ড', 'salpicadero', 'لوحة أجهزة القياس', 'dashboard', 'приборная панель', '仪表盘,en', 'gösterge paneli', 'painel de instrumentos', 'műszerfal', 'tableau de bord', 'ταμπλό', 'Armaturenbrett', 'cruscotto', 'หน้าปัด', 'ڈیش بورڈ', 'डैशबोर्ड', 'Dashboard', 'dasbor', 'ダッシュボード', '계기판,en'),
(17, 'settings', 'settings', 'সেটিংস', 'ajustes', 'إعدادات', 'instellingen', 'настройки', '设置,en', 'ayarları', 'definições', 'beállítások', 'réglages', 'Ρυθμίσεις', 'Einstellungen', 'impostazioni', 'การตั้งค่า', 'ترتیبات', 'सेटिंग्स', 'obitus', 'Pengaturan', '設定', '설정,en'),
(18, 'profile', 'profile', 'প্রফাইল', 'perfil', 'الملف الشخصي', 'profiel', 'профиль', '轮廓,en', 'profil', 'perfil', 'profil', 'profil', 'προφίλ', 'Profil', 'Profilo', 'รายละเอียด', 'پروفائل', 'प्रोफ़ाइल', 'profile', 'profil,en', 'プロフィール', '프로필'),
...
(86, 'manage_laboratorist', 'manage laboratorist', 'ল্যাবরেটরিস্ট পরিচালনা', 'gestionar laboratorista', 'إدارة laboratorist', 'beheren laboratorist', 'управлять laboratorist', '管理laboratorist“', 'laboratorist yönetmek', 'gerenciar laboratorista', 'kezelni laboratorist', 'gérer laboratorist', 'διαχείριση laboratorist', 'verwalten laboratorist', 'gestire laboratorist', 'จัดการ laboratorist', 'laboratorist کا انتظام', 'laboratorist प्रबंधन', 'laboratorist curo', 'mengelola laboratorist', 'laboratoristを管理', 'laboratorist 관리'),
(87, 'laboratorist_list', 'laboratorist list', 'ল্যাবরেটরিস্ট তালিকা', 'Lista laboratorista', 'قائمة laboratorist', 'laboratorist lijst', 'laboratorist список', 'laboratorist列表', 'laboratorist liste', 'lista laboratorista', 'laboratorist lista', 'Liste d\'laboratorist', 'Λίστα laboratorist', 'laboratorist Liste', 'Lista laboratorist', 'รายการ laboratorist', 'laboratorist فہرست', 'laboratorist सूची', 'laboratorist album', 'Daftar laboratorist', 'laboratoristリスト', 'laboratorist 목록'),
(88, 'add_laboratorist', 'add laboratorist', 'ল্যাবরেটরিস্ট যোগ করুন', 'añadir laboratorista', 'إضافة laboratorist', 'voegen laboratorist', 'добавить laboratorist', '添加laboratorist“', 'laboratorist ekleyin', 'adicionar laboratorista', 'hozzá laboratorist', 'ajouter laboratorist', 'προσθήκη laboratorist', 'laboratorist hinzufügen', 'aggiungere laboratorist', 'เพิ่ม laboratorist', 'laboratorist شامل', 'laboratorist जोड़', 'adde laboratorist', 'tambahkan laboratorist', 'laboratoristを追加', 'laboratorist 추가'),
...
CREATE TABLE `log` (
  ...
  `description` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ip` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `medicine` (
  ...
  `manufacturing_company` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `status` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
(2, 'cherif amine sriret', 2, 'dqdaz', '8000', 'dazdad', '60');
...
CREATE TABLE `message` (
  ...
  `user_from_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `user_from_id` int NOT NULL,
  `user_to_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(1, 'Preeti Goswami', 'nurse@nurse.com', 'nurse', 'Mumbai, India', '9800000077'),
(2, 'cherif amine sriret', 'cherifsriret@gmail.com', 'admin', '161 cité 400 logts Tixraine Birkhadem', '+213699042510');
...
CREATE TABLE `patient` (
  ...
  `phone` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sex` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `birth_date` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `age` int NOT NULL,
  `blood_group` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(1, 'Emmanuel', 'Patient@patient.com', 'patient', 'Nigeria', '9800000000', '', '', 0, '', 1448984171),
(2, 'John', 'John@patient.com', 'admin', 'Thunder Bay, ON', '+213699042510', 'male', '11/15/1990', 32, 'O+', 1669703827);


CREATE TABLE `payment` (
  `payment_id` int NOT NULL,
  `payment_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `transaction_id` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `invoice_id` int NOT NULL,
  `patient_id` int NOT NULL,
...
(2, 'Blood Test', '275027', 1, 1, 'cash', 'Blood test for maleria, Nov 2015', 500, 1669709863),
(3, 'dazd', '378935', 4, 2, 'cash', 'azda adzazd', 7800, 1669710026);
...
(1, 'Manoj Hedao', 'pharmacist@pharmacist.com', 'pharmacist', 'Mumbai, India', '9807787870'),
(2, 'cherifsriret@gmail.com2', 'cherifsriret@gmail.com', 'admin', 'C00002', '699042510');
...
CREATE TABLE `prescription` (
  ...
  `doctor_id` int NOT NULL,
  `patient_id` int NOT NULL,
  `case_history` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `medication` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `medication_from_pharmacist` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `description` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `report` (
  ...
  `type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'operation,birth,death',
  `description` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `timestamp` int NOT NULL,
  `doctor_id` int NOT NULL,
  `patient_id` int NOT NULL
...
ALTER TABLE `accountant`
  MODIFY `accountant_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `bed`
  MODIFY `bed_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;


ALTER TABLE `bed_allotment`
  MODIFY `bed_allotment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

ALTER TABLE `blood_bank`
  MODIFY `blood_group_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;


ALTER TABLE `blood_donor`
  MODIFY `blood_donor_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `diagnosis_report`
  MODIFY `diagnosis_report_id` int NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `email_template`
  MODIFY `email_template_id` int NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `laboratorist`
  MODIFY `laboratorist_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;


ALTER TABLE `language`
  MODIFY `phrase_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=234;

ALTER TABLE `log`
  MODIFY `log_id` int NOT NULL AUTO_INCREMENT;

ALTER TABLE `medicine`
  MODIFY `medicine_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;


ALTER TABLE `medicine_category`
  MODIFY `medicine_category_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;


ALTER TABLE `noticeboard`
  MODIFY `notice_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

ALTER TABLE `nurse`
  MODIFY `nurse_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `pharmacist`
  MODIFY `pharmacist_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `settings`
  MODIFY `settings_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
